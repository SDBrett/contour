...
The Contour repo includes step-by-step examples of how to generate certificates from a command line if you want to [generate them by hand](/guides/cert-manager#generating-example-grpc-tls-certificates); the example/contour [example](https://github.com/projectcontour/contour/blob/master/examples/contour) includes a [job](https://github.com/projectcontour/contour/blob/master/examples/contour/02-job-certgen.yaml) which automatically generate the certificates, or you could provide your own based on your IT security requirements.
