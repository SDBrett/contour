...
These annotations are applied to *Ingress* objects
...
These annotations are applied to *Service* objects.
...
## Depreciated annotations

<p class="alert-deprecation">
<b>Deprecation Notice</b></br>
All annotations below are deprecated and are only provided for historical / migration purposes.
</p>
